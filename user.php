...
<body>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-6 text-center">
          ...
          <p> </p>
          <a href="login.php" class="btn-get-started">Tambahkan Data Kunjungan Secara Manual?</a>
        </div>
      </div>
    </div>
  ...
  <style>
    ...
    <table border="">
      <tr bgcolor="#000">
        <th align=center width="150">PHONE</th>
        <th align=center width="150">NAMA PENGUNJUNG</th>
        <th align=center width="180">TANGGAL KUNJUNGAN</th>
  ...
  if(isset($_GET['phone'])){
    $phone = $_GET['phone'];
    mysqli_query($koneksi,"DELETE FROM user WHERE phone='$phone'");
  }
  ...
  while($kolom = mysqli_fetch_array($query)){
      $phone = $kolom["phone"];
      $nama = $kolom["nama_user"];
      $tanggal = $kolom["tanggal_kunjungan"];
      $hapus ="<a href=?phone=$phone>Delete</a>";
      echo "<tr><td align=center>$phone</td><td>$nama</td><td>$tanggal</td><td align=center>$hapus</td></tr>";
  }
