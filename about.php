      ...
      <div class="container position-relative">
        <div class="row d-flex justify-content-center">
          <div class="col-lg-6 text-center">
            ...
            <p>This website is useful for those of you who are dead in style. Here there are lots of stylish inspiration in the style of models or aesthetics. If you die style, welcome to my website</p>
          </div>
        </div>
      </div>
    </div><!-- End Page Header -->
