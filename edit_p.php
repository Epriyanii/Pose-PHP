  ...
  <?php
    ...
    <table>
        <tr>
            ...
            <td><input name=id_pose value=<?php echo $kolom['id_pose'];?> ></td></br>
        </tr>
        <tr>
            <td width="130">Nama Kategori :</td>
            <td><input name=id_kategori value=<?php echo $kolom['id_kategori'];?> ></td>
        </tr>
        <tr>
            <td width="130">Judul Pose    :</td>
            <td><input name=judul_pose value=<?php echo $kolom['judul_pose'];?> ></td>
        </tr>
        <tr>
            <td width="130">Gambar Pose   :</td>
            <td><input type="file" name="gambar_pose" value=<?php echo $kolom['gambar_pose'];?> ></td></br>
