...
<body>
  ...
  <form action="aksi_data.php" method=POST>
    <table>
        <tr>
            <td width="130">ID kategori     :</td>
            <td><input type="text" name="id_ktegori"></td></br>
        </tr>
        <tr>
        ...
        <tr>
            <td></td>
            <td><input type="submit" value="Simpan" name="proses" onclick="alert('Data telah ditambahkan')"><input type="reset"></td>
        </tr>
    </table></br></br></br></br>
  </form>
  </section>
