    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-6 text-center">
          <h2>Welcome to <span>INSPIRASI FOTO</span></h2>
          <p> Silahkan isi daftar kunjungan anda !! </p>
        </div>
      </div>
    </div>
...
<table>
    ...
    <tr>
        <td width = "130">Tanggal Kunjungan     : </td>
        <td><input type= "text" name = "tanggal_kunjungan"></td>
    </tr>
    <tr>
        <td></td>
        <td><input type= "Submit" value="Masuk" name = "input"><input type="reset"></td>
    </tr>
</table>
</form>
